import{_ as e,c as a,o as n,ae as t}from"./chunks/framework.iBmvQ__U.js";const m=JSON.parse('{"title":"Architecture","description":"","frontmatter":{},"headers":[],"relativePath":"scalux/fr/architecture.md","filePath":"scalux/fr/architecture.md"}'),p={name:"scalux/fr/architecture.md"};function i(l,s,r,o,c,u){return n(),a("div",null,s[0]||(s[0]=[t(`<h1 id="architecture" tabindex="-1">Architecture <a class="header-anchor" href="#architecture" aria-label="Permalink to &quot;Architecture&quot;">​</a></h1><p><code>scalux</code> est une bibliothèque indépendante de votre architecture de fichier.</p><p>Aucun découpage de fichiers n’est imposé, mais il est recommandé d’adopter une approche claire et évolutive : <strong>commencer petit, grandir naturellement, rester cohérent.</strong></p><h2 id="principes" tabindex="-1">Principes <a class="header-anchor" href="#principes" aria-label="Permalink to &quot;Principes&quot;">​</a></h2><ol><li><strong>Minimalisme initial</strong> : commencez toujours par la solution la plus simple possible.</li><li><strong>Évolutivité naturelle</strong> : ajoutez de la complexité uniquement lorsque le besoin se fait ressentir.</li><li><strong>Cohérence et modularité</strong> : chaque fichier doit avoir une responsabilité clairement définie.</li></ol><p>Par exemple pour un tout petit projet ou du prototypage rapide :</p><ul><li><strong>Un seul fichier d’état</strong> : un fichier unique pour définir votre état initial, les composants connectés, et le store.</li><li><strong>Pas de slices, pas de machines</strong> : gardez-le minimal.</li></ul><p>Fera l&#39;affaire :</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki dark-plus vp-code" tabindex="0"><code><span class="line"><span style="color:#9CDCFE;">src</span><span style="color:#D4D4D4;">/</span></span>
